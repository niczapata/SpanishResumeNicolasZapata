...
\textbf{Analista \& Desarrollador – Conviventia} \hfill \textit{Feb 2023 – Abr 2023}
\begin{itemize}[leftmargin=*, nosep, topsep=4pt]
  ...
  \item \textbf{implementé} un \textbf{Dashboard} por medio de \textbf{Google Sheets}, proporcionando visuales y informes en tiempo real para la toma de decisiones.
\end{itemize}

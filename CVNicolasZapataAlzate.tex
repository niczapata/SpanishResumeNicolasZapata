...
% ===== OBJETIVO =====
\section*{OBJETIVO}
Crear soluciones de software para mejorar y hacer más fácil el uso cotidiano, y contribuir a la industria del software.
...
\begin{multicols}{2}
  ...
  \begin{itemize}[leftmargin=*, nosep]
      \item \faPhone\ \textbf{Teléfono:} (+57) 3128856774
      \item \faEnvelope\ \textbf{Correo:} \href{mailto:works_nicolasz@outlook.com}{works\_nicolasz@outlook.com}
      \item \faGlobe\ \textbf{Página:} \href{https://nicolas-zapata-portfolio.vercel.app/}{nicolas-zapata-portfolio.vercel.app}
      \item \faLinkedin\ \textbf{LinkedIn:} \href{https://www.linkedin.com/in/nicolas-zapata-al/}{linkedin.com/in/nicolas-zapata-al}
      \item \faGithub\ \textbf{GitHub:} \href{https://github.com/niczapata}{github.com/niczapata}
      \item \faGitlab\ \textbf{GitLab:} \href{https://gitlab.com/NicolasZapata}{gitlab.com/NicolasZapata}
  \end{itemize}
...
\begin{itemize}[leftmargin=*, nosep, topsep=4pt]
    ...
    \item \textbf{Herramientas de desarrollo:} DeepSeek, Cline, Android Studio Arduino, Unity, Windsurf, Cursor, Visual Studio Code, IntelliJ IDEA, PyCharm, NeoVim, RStudio.
    ...
    \item \textbf{Otras Capacidades:} Notion, Trello, Jira, Figma, Git, GitHub, Docker, GitLab, BitBucket, Microservicios, Azure.
    \item \textbf{Sistemas Operativos:} Arch Linux, Ubuntu, Windows.
...
\textit{Repositorio:} \href{https://github.com/NicolasZapata/Classification_Tree_UNIR}{github.com/NicolasZapata/Classification\_Tree\_UNIR}
...
\textit{Repositorio:} \href{https://github.com/NicolasZapata/Data_Mining_Unir-1}{github.com/NicolasZapata/Data\_Mining\_Unir-1}
...
\begin{itemize}[leftmargin=*, nosep]
    \item \textbf{Documento de identidad:} 1053873921 de Manizales
    \item \textbf{Lugar y fecha de nacimiento:} 12 de marzo de 1999 en Manizales, Caldas, Colombia
    \item \textbf{Estado civil:} Soltero
    \item \textbf{Dirección:} Carrera 1 con calle 11, N° 11-41, Manizales, Caldas, Colombia
\end{itemize}
